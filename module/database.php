			...
			foreach($querys as $query){
				if(trim($query) != ""){
					...
					if($query_query!=false){
						$res .= "<p><span class='strong' style='cursor: default;' ondblclick=\"$('#dbQuery').val([$('#dbQuery').val(), $(this).text()].filter(function(e) {return e !== '';}).join('\\n'));\">".html_safe($query).";</span>&nbsp;&nbsp;&nbsp;<span class='strong'>[</span> ok <span class='strong'>]</span></p>";
						if(!empty($pagination)){
							$res .= "<p>".$pagination."</p>";
						}
